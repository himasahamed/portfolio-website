    ...
    <>
      ...
      <script type="application/ld+json">
        {JSON.stringify({
          ...
          "address": {
            "@type": "PostalAddress",
            "streetAddress": "81 B Old Post Office Road, Palamunai",
          ...
          "sameAs": [
            ...
            "https://www.instagram.com/himasahamet"
          ],
          "worksFor": {
            "@type": "Organization",
            "name": "Freelance"
...
const App = () => {
  ...
  const sendEmail = (e) => {
    ...
    if (!serviceId || !templateId || !publicKey) {
      ...
      showToastMessage(`Thanks ${formData.from_name}! I'll get back to you soon.`, true);
    ...
    emailjs.sendForm(serviceId, templateId, form.current, publicKey)
      .then(() => {
        showToastMessage(`Thanks ${formData.from_name}! Your message has been sent successfully.`, true);
        setFormData({ from_name: '', from_email: '', message: '' });
        setIsSubmitting(false);
      })
      .catch((error) => {
        console.error('EmailJS Error:', error);
        showToastMessage('Failed to send message. Please email me directly.', false);
        setIsSubmitting(false);
      });
  };
                ...
                <div className="space-y-5 sm:space-y-6">
                  <div className="p-5 sm:p-6 rounded-2xl bg-white/5 backdrop-blur-sm border border-white/10">
                    ...
                    <div className="space-y-2 sm:space-y-3 text-gray-300 text-sm sm:text-base">
                      ...
                      <p className="flex items-center gap-3">
                        <span className="text-orange-400">📍</span> 81 B Old Post Office Road, Palamunai, Dehiwala, Sri Lanka
                      </p>
                      <p className="flex items-center gap-3 break-all">
                  ...
                  <div className="p-5 sm:p-6 rounded-2xl bg-white/5 backdrop-blur-sm border border-white/10">
                    ...
                    <div className="flex gap-3 sm:gap-4 flex-wrap">
                      ...
                      <a href="https://www.instagram.com/himasahamet" target="_blank" rel="noopener noreferrer" className="p-2 sm:p-3 rounded-full bg-white/10 hover:bg-white/20 transition" aria-label="Instagram">
                        <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="currentColor" viewBox="0 0 24 24">
